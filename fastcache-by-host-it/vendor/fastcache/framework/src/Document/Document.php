...
abstract class Document
{
	 ...
	 *
	 * @return  \FastCacheFramework\Document\Document
	 */
	public static function getInstance($type, Container $container, $classPrefix = '\\FastCacheFramework')
	{
		if (!array_key_exists($type, self::$instances))
		{
			...
			{
				$className = '\\FastCacheFramework\\Document\\Html';
			}
	 ...
	 *
	 * @return \FastCacheFramework\Application\Application
	 */
