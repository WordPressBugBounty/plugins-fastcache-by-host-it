...
namespace FastCacheFramework\Mvc\Compiler;
...
class Blade implements CompilerInterface
{
	...
	protected function compileStatementsCallback($match)
	{
		...
		{
			$match[0] = $this->$method(fastcache_array_get($match, 3));
		}
	...
	{
		return "<?php echo \\FastCacheFramework\\Text\\Text::_$expression; ?>";
	}
	...
	{
		return "<?php echo \\FastCacheFramework\\Text\\Text::sprintf$expression; ?>";
	}
	...
	{
		if (fastcache_starts_with($expression, '('))
		{
	...
	{
		return "<?php \\FastCacheFramework\\Utils\\Template::addCss{$expression}; ?>";
	}
	...
	{
		return "<?php \\FastCacheFramework\\Utils\\Template::addJs{$expression}; ?>";
	}
	...
	{
		return "<?php echo \\FastCacheFramework\\Utils\\Template::parsePath{$expression}; ?>";
	}
