...
namespace FastCacheFramework\Input;
 ...
 * it in a safe manner.
 *
 * @package FastCacheFramework\Input
 *
...
{
	/** @var   \FastCacheFramework\Input\Filter  Filter object to use. */
	 ...
	 *
	 * @return  \FastCacheFramework\Input\Input
	 */
	public function __construct($source = null, $options = [])
	{
		...
		{
			$this->filter = \FastCacheFramework\Input\Filter::getInstance();
		}
	 ...
	 *
	 * @return  \FastCacheFramework\Input\Input  The request input object
	 */
	public function __get($name)
	{
		...
		$className = '\\FastCacheFramework\\Input\\' . ucfirst($name);
		...
		{
			$this->inputs[$name] = new \FastCacheFramework\Input\Input($GLOBALS[$superGlobal]);
