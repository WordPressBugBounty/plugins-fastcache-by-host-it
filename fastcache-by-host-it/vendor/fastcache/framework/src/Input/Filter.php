...
{
	/**
	 * @var    array  A container for \FastCacheFramework\Input\Filter instances.
	 */
	 ...
	 *
	 * @return  \FastCacheFramework\Input\Filter
	 */
	 ...
	 * @param   integer  $xssAuto     Only auto clean essentials = 0, Allow clean blacklisted tags/attr = 1
	 *
	 * @return  \FastCacheFramework\Input\Filter  The \FastCacheFramework\Input\Filter object.
	 */
	public static function &getInstance($tagsArray = array(), $attrArray = array(), $tagsMethod = 0, $attrMethod = 0, $xssAuto = 1)
	{
		...
		{
			self::$instances[$sig] = new \FastCacheFramework\Input\Filter($tagsArray, $attrArray, $tagsMethod, $attrMethod, $xssAuto);
		}
