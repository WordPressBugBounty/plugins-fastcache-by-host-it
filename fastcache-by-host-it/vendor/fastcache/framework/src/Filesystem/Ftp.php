...
namespace FastCacheFramework\Filesystem;
...
class Ftp implements FilesystemInterface
{
	...
	public function write($fileName, $contents)
	{
		...
		class_exists('\\FastCacheFramework\\Utils\\Buffer', true);

		$handle = fopen('fastcache://fastcache_filesystem_ftp', 'r+');
	...
	public function copy($from, $to)
	{
		...
		// Make sure the fastcache:// wrapper is loaded
		class_exists('\\FastCacheFramework\\Utils\\Buffer', true);
