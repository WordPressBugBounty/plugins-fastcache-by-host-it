...
namespace FastCacheFramework\Uri;
 ...
 * URI parsing helper
 *
 * @package FastCacheFramework\Uri
 */
class Uri
{
	...
	/** @var   array  An array of \FastCacheFramework\Uri\Uri instances. */
	...
	/**
	 * Returns the global \FastCacheFramework\Uri\Uri object, only creating it
	...
	public static function getInstance($uri = 'SERVER')
	{
		if (empty(self::$instances[$uri]))
		{
			...
			self::$instances[$uri] = new \FastCacheFramework\Uri\Uri($theURI);
		}
