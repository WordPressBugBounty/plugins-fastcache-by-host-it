...
namespace FastCacheFramework\Application;

use FastCacheFramework\Container\Container;
use FastCacheFramework\Document\Document;
use FastCacheFramework\Exception;
 ...
 *
 * @package FastCacheFramework\Application
 */
